	...
	function init() {
	  ...
	  if ($('#about-map').length) {
	    ...
	    if ($('#' + aboutMapId).data('placemark')) {
	      var aboutMapPlacemarkCoord = $('#' + aboutMapId).data('placemark').split(",");
	      var aboutMapPlacemark = new ymaps.Placemark(aboutMapPlacemarkCoord, {}, {
	        iconLayout: 'default#image',
